    ...
    $.ajax({
        ...
        success:function(respuesta) {
            ...
            if (respuesta == 1) {
                ...
                Swal.fire("Correcto","Actualizado con exito!","success");
                
            } else {
                Swal.fire("Fallo","Error al actualizar! " + respuesta, "error");
            }
        }
    });
    ...
    $.ajax({
        ...
        success:function(respuesta) {
            ...
            if (respuesta == 1) {
                ...
                Swal.fire("Correcto","Cambio de password con exito!","success");
            } else {
                Swal.fire("Fallo","Error al actualizar el password! " + respuesta, "error");
            }
        }
    });
...
function cambioEstatusUsuario(idUsuario, estatus) {
    $.ajax({
        ...
        success:function(respuesta) {
            ...
            if (respuesta == 1) {
                $('#tablaUsuariosLoad').load("usuarios/tablaUsuarios.php");
                Swal.fire("Correcto","Cambio de estatus con exito!","success");
            } else {
                Swal.fire("Fallo","Error al cambiar el estatus! " + respuesta, "error");
            }
        }
    });
}
        ...
        if (result.isConfirmed) {
            $.ajax({
                ...
                success:function(respuesta) {
                    ...
                    if (respuesta == 1) {
                        $('#tablaUsuariosLoad').load("usuarios/tablaUsuarios.php");
                        Swal.fire("Correcto","Usuario eliminado con exito!","warning");
                    } else {
                        Swal.fire("Fallo","Error al eliminar usuario! " + respuesta, "error");
                    }
                }
            });
        }
